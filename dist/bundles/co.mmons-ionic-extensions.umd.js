(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@ionic/angular'), require('@angular/cdk/scrolling'), require('@angular/common'), require('@angular/forms'), require('@co.mmons/angular-intl'), require('@co.mmons/js-utils/core'), require('@angular/platform-browser'), require('@co.mmons/rxjs-utils'), require('@co.mmons/angular-extensions/browser/match-media'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('@co.mmons/ionic-extensions', ['exports', '@angular/core', '@ionic/angular', '@angular/cdk/scrolling', '@angular/common', '@angular/forms', '@co.mmons/angular-intl', '@co.mmons/js-utils/core', '@angular/platform-browser', '@co.mmons/rxjs-utils', '@co.mmons/angular-extensions/browser/match-media', '@angular/router'], factory) :
    (global = global || self, factory((global.co = global.co || {}, global.co.mmons = global.co.mmons || {}, global.co.mmons['ionic-extensions'] = {}), global.ng.core, global.angular, global.ng.cdk.scrolling, global.ng.common, global.ng.forms, global.angularIntl, global.core$1, global.ng.platformBrowser, global.rxjsUtils, global.matchMedia, global.ng.router));
}(this, function (exports, core, angular, scrolling, common, forms, angularIntl, core$1, platformBrowser, rxjsUtils, matchMedia, router) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    exports.ɵc = DateTimePickerOverlay;
    exports.ɵd = SelectLabel;
    exports.ɵe = SelectOverlayContent;
    exports.ɵf = ExpandingSearchbarStyles;
    exports.ɵg = IonicInputFix;
    exports.ɵh = IonicBackButtonFix;
    exports.ɵi = IonicItemTargetFix;
    exports.ɵj = LoaderController;
    exports.ɵk = TextareaAutosize;
