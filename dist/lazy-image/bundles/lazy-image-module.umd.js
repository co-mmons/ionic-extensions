(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@co.mmons/ionic-extensions/lazy-image', ['exports', '@angular/core', '@co.mmons/js-utils/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.co = global.co || {}, global.co.mmons = global.co.mmons || {}, global.co.mmons["ionic-extensions"] = global.co.mmons["ionic-extensions"] || {}, global.co.mmons["ionic-extensions"]["lazy-image"] = {}), global.ng.core, global.core));
    ...
    ***************************************************************************** */
    ...
    LazyImageContainer.propDecorators = {
        children: [{ type: core$1.ContentChildren, args: [core$1.forwardRef(function () { return LazyImage; }), { descendants: true },] }]
    };
    ...
    LazyImage.ctorParameters = function () { return [
        ...
        { type: LazyImageContainer, decorators: [{ type: core$1.Optional }, { type: core$1.Inject, args: [core$1.forwardRef(function () { return LazyImageContainer; }),] }] }
    ]; };
    LazyImage.propDecorators = {
        children: [{ type: core$1.ContentChildren, args: [LazyImage, { descendants: true },] }],
        src: [{ type: core$1.Input, args: ["ionx-lazy-image",] }],
        alternate: [{ type: core$1.Input, args: ["ionx-lazy-image-alternate",] }]
    };
...
//# sourceMappingURL=lazy-image-module.umd.js.map
