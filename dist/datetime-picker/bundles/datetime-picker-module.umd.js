(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@co.mmons/angular-intl'), require('@co.mmons/ionic-extensions/buttons'), require('@co.mmons/ionic-extensions/select'), require('@ionic/angular'), require('@co.mmons/js-utils/core')) :
    typeof define === 'function' && define.amd ? define('@co.mmons/ionic-extensions/datetime-picker', ['exports', '@angular/common', '@angular/core', '@angular/forms', '@co.mmons/angular-intl', '@co.mmons/ionic-extensions/buttons', '@co.mmons/ionic-extensions/select', '@ionic/angular', '@co.mmons/js-utils/core'], factory) :
    (global = global || self, factory((global.co = global.co || {}, global.co.mmons = global.co.mmons || {}, global.co.mmons['ionic-extensions'] = global.co.mmons['ionic-extensions'] || {}, global.co.mmons['ionic-extensions']['datetime-picker'] = {}), global.ng.common, global.ng.core, global.ng.forms, global.angularIntl, global.buttons, global.select, global.angular, global.core$1));
}(this, (function (exports, common, core, forms, angularIntl, buttons, select, angular, core$1) { 'use strict';
    ...
    var DateTimePickerModule = /** @class */ (function () {
        ...
        DateTimePickerModule = __decorate([
            core.NgModule({
                ...
                imports: [common.CommonModule, forms.FormsModule, angular.IonicModule, angularIntl.IntlModule, select.SelectModule, buttons.ButtonsModule]
            })
