...
import { Component, ComponentFactoryResolver, ComponentRef, ElementRef, EventEmitter, Injector, Input, ViewChild, ViewContainerRef } from "@angular/core";
import { DomSanitizer } from "@angular/platform-browser";
import { ModalController } from "@ionic/angular";
var Dialog = /** @class */ (function () {
    function Dialog(injector, sanitizer, elementRef, modalController, resolver) {
    ...
    Dialog = __decorate([
        ...
        __metadata("design:paramtypes", [Injector, DomSanitizer, ElementRef, ModalController, ComponentFactoryResolver])
    ], Dialog);
    return Dialog;
}());
export { Dialog };
