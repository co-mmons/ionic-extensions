import {Component, ContentChildren, ElementRef, Input, OnChanges, OnInit, Optional, QueryList, SimpleChanges, ViewEncapsulation, Output, EventEmitter} from "@angular/core";
