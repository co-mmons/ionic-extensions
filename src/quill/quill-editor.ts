...
@Component({
    ...
    template: `<div></div>`,
    providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => QuillEditor), multi: true },
        { provide: NG_VALIDATORS, useExisting: forwardRef(() => QuillEditor), multi: true }
    ],
    encapsulation: ViewEncapsulation.None
})
export class QuillEditor implements AfterViewInit, ControlValueAccessor, OnChanges, Validator {
